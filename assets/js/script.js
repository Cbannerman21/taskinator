...
var taskFormHandler = function(event) {
    ...
    // check if task is new or one being edited by seeing if it has a data-task-id attributte
    ...
    // no data attribute, so create object as normal and padd to createTaskEl function
    else {
        var taskDataObj = {
            name: taskNameInput,
            type: taskTypeInput,
...
var deleteTask = function(taskId) {
    ...
    // reassign tasks to array to be the same as updatedTaskArr
